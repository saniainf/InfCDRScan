...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="83783cde-76ac-4325-a2f5-65de58caaff3" noBmpOnMenu="true"
                type="checkButton"
                check="*Docker('4f47a95c-e85a-45e2-8635-d61bc7fb2de8')"
                dynamicCategory="2cc24a3e-fe24-4708-9a74-9c75406eebcd"
                userCaption="Inf CDR Scan"
                enable="true"/>

      <!-- Define the web control which will be placed on our docker -->
      <itemData guid="9278365e-fe71-4fa5-9d39-aeba41beb296"
                type="wpfhost"
                hostedType="Addons\InfCDRScan\InfCDRScan.dll,InfCDRScan.DockerUI"
                enable="true"/>
  ...
  <xsl:template match="uiConfig/dockers">
    <xsl:copy>
      ...
      <dockerData guid="4f47a95c-e85a-45e2-8635-d61bc7fb2de8"
                  userCaption="Inf CDR Scan"
                  wantReturn="true"
                  focusStyle="noThrow">
        <container>
          <!-- add the webpage control to the docker -->
          <item dock="fill" margin="0,0,0,0" guidRef="9278365e-fe71-4fa5-9d39-aeba41beb296"/>
        </container>
      </dockerData>
    </xsl:copy>
  </xsl:template>
